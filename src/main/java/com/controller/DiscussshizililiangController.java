...
public class DiscussshizililiangController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussshizililiangEntity discussshizililiang, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussshizililiangEntity discussshizililiang, HttpServletRequest request){
        EntityWrapper<DiscussshizililiangEntity> ew = new EntityWrapper<DiscussshizililiangEntity>();
    	PageUtils page = discussshizililiangService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussshizililiang), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
