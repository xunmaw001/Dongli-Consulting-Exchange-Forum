...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">投稿信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>投稿信息管理</span></li>
								<li class="breadcrumb-item active"><span>投稿信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">投稿信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>投稿主题</th>
											<th onclick="sort('tougaoshijian')">投稿时间<i id="tougaoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tougaozhutiCell  = document.createElement('td');

						  if(item.tougaozhuti != null && item.tougaozhuti != "" && item.tougaozhuti.length >= 11){
			  	tougaozhutiCell.innerHTML = item.tougaozhuti.substring(0, 10) + "..."; 
			  }else{
			  	tougaozhutiCell.innerHTML = item.tougaozhuti;
			  }


			row.appendChild(tougaozhutiCell);
			var tougaoshijianCell  = document.createElement('td');

						 tougaoshijianCell.innerHTML = item.tougaoshijian;


			row.appendChild(tougaoshijianCell);
            ...
            crossBtn1.innerHTML = "投稿"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"yijiantougao\")");
			if(crossBtnControl('投稿') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tougaoxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"tougaoxinxi");
